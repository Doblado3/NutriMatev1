...
class PerfilFragmentAdm : Fragment() {
    ...
    private lateinit var radioGroupAdm: RadioGroup
    private lateinit var emailAdm: EditText
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        telefono = view.findViewById(R.id.editTextPhoneAdm)
        textoSexo = view.findViewById(R.id.textSexAdm)
        nombre = view.findViewById(R.id.editTextNombreAdm)
        apellidos = view.findViewById(R.id.editTextApellidosAdm)
        fechaNac = view.findViewById(R.id.editTextDateAdm)
        radioGroupAdm = view.findViewById(R.id.radioGroupAdm)
        emailAdm = view.findViewById(R.id.editTextEmailAdm)

        val user = Firebase.auth.currentUser
        user?.let {
            emailAdm.setText(user.email)
            emailAdm.isEnabled = false
        }
        ...
        val updateButton: Button = view.findViewById(R.id.botonActualizarAdm)
    ...
    private fun actualizarBD() {
        ...
        col.document(emailAdm.text.toString()).set(nuevosDatos)
    ...
    private fun mostrarInfoAdmin() {
        val col = Firebase.firestore.collection("Administradores")
        val user = Firebase.auth.currentUser
            ...
            if (!emailUsuario.isNullOrEmpty()) {
                col.document(emailUsuario).get()
                    ...
                    .addOnFailureListener { e ->
                        ...
                        Alert.showAlert(requireContext(),"Error al obtener los datos del admin")
                    }
            } else {
